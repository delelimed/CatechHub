...
final dataShareDataProvider = StateProvider<Map<String, dynamic>?>(
  (ref) => null,
);
...
final dataShareOptionsProvider = StateProvider<DataShareOptions?>(
  (ref) => null,
);

// Indice remoto scansionato (usato dal lato mittente per calcolare il diff)
final scannedRemoteIndexProvider = StateProvider<Map<String, dynamic>?>(
  (ref) => null,
);

// Dati differenziali preparati (il risultato del confronto)
final differentialDataProvider = StateProvider<Map<String, dynamic>?>(
  (ref) => null,
);
